...
const enviarAvisoCanal = async (conn, notifyChat = null) => {
  const mensaje = `⭐ *¡Te invitamos a nuestro canal!* 🌟\n\nEste es el canal oficial 📢 de *Gabriel*:\n\n👉 https://whatsapp.com/channel/0029VbAIBneK0IBjjFDyMn31Síguelo para estar al tanto de * novedades, y actualizaciones*. ¡Gracias por tu apoyo! 🙌`;
